...
with open(
        './ML/Python/topic/dynamic/twitter_preprocessing_0720.csv',
        'w',
        encoding='UTF-16LE',
        newline='') as csvfile:
    column = [[
...
dfinal_tw.to_csv(
    './ML/Python/topic/dynamic/final_twitter_preprocessing_0720.csv',
    encoding='UTF-16LE',
    columns=['id', 'created_time', 'language', 'message', 're_message'])
...
with open("./ML/Python/topic/dynamic/doc_clean.txt", "wb") as fp:  #Pickling
    pickle.dump(doc_clean, fp)
dictionary = corpora.Dictionary(doc_clean)
dictionary.save('./ML/Python/topic/dynamic/corpus.dict')
