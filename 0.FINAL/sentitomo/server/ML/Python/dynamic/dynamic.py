...
with open('./ML/Python/dynamic/twitter_preprocessing_0720.csv', 'w', encoding='UTF-16LE', newline='') as csvfile:
...
for i in range(len(dlang['message'])):
    ...
    with open('./ML/Python/dynamic/twitter_preprocessing_0720.csv', 'a', encoding='UTF-16LE', newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerows([features])
df_postncomment = pd.read_csv('./ML/Python/dynamic/twitter_preprocessing_0720.csv', encoding = 'UTF-16LE', sep=',')
...
dfinal_tw.to_csv('./ML/Python/dynamic/final_twitter_preprocessing_0720.csv', encoding='UTF-16LE',columns = ['id', 'created_time', 'language','message','re_message'])
...
import time
start_time = time.time()
df_postn = pd.read_csv('./ML/Python/dynamic/final_twitter_preprocessing_0720.csv', encoding = 'UTF-16LE', sep=',',index_col=0)
...
with open("./ML/Python/dynamic/doc_clean.txt", "wb") as fp:   #Pickling
    pickle.dump(doc_clean, fp)
dictionary = corpora.Dictionary(doc_clean)
dictionary.save('./ML/Python/dynamic/corpus.dict')
