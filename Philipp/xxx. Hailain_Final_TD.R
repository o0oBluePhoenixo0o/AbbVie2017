...
Final_TW_Newest <- read.csv("Final_Manual_3007.csv", as.is = TRUE, sep = ",", stringsAsFactors = F)

###get key, tweets, time of TW dataset
Final_TW_Tweets<- Final_TW_Newest[,which(names(Final_TW_Newest) %in% c("key","created_time","message"))]
