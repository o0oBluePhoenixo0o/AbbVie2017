...
#have a look at the first six starting with "r" and tweets numbered 101 to 110
idx <- which(dimnames(tdm)$Terms=="r")
inspect(tdm[idx+(0:5),101:110])

#inspect frequent words
findFreqTerms(tdm, lowfreq = 10000)
...
#write as .csv document
write.csv(dff,file = "TrainingTweetsDictionary.csv")
